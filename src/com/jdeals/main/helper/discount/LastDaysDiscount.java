...
public class LastDaysDiscount extends RatedDiscount {
	...
	/**
	 * @see Order
	 * @see com.jdeals.main.helper.discount.RatedDiscount#scan(com.jdeals.main.entity.Order, boolean)
	 */
	@Override
	...
	/** 
	 * @see com.jdeals.main.helper.discount.RatedDiscount#equals(java.lang.Object)
	 */
	@Override
