...
public class RatedDiscount <T extends RatedDiscount> extends MyObject implements DiscountInterface<T>,Serializable,Cloneable {
	...
	/**
	 * @see com.jdeals.main.helper.discount.DiscountInterface#compareTo(java.lang.Object)
	 */
	@Override
	...
	/**
	 * @see Order
	 * @see com.jdeals.main.helper.discount.DiscountInterface#scan(com.jdeals.main.entity.Order, boolean)
	 */
	@Override
