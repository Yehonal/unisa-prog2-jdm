...
import com.jdeals.main.view.gui.JAppletMain;
import com.jdeals.main.view.gui.JFrameCli;
import com.jdeals.main.view.gui.JFrameLogin;
import com.jdeals.main.view.gui.JFrameMain;

/**
 * This is the core of JDeals Manager. It keeps instances dataset of registered users
 * and of the Store itself.
 * It also provides methods to handle the user list ( such as Login, Register, findUser etc.)
...
public class JDealsController {
	 ...
	 * @return true if the registration has been completed, otherwise return false
	 * @throws Exception the exception
	 * @see User
	 * @see EmailValidator
	 */
	...
	/**
	 * Finds an user inside the list using ( id or email ) and ( password if not null )  .
	 *
	 * @param username the username
	 * @param email the email
	 * @param password the password
	...
	/**
	 * Retrieves extra settings class instance
