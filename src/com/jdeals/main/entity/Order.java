...
public class Order implements Serializable,Cloneable {
	...
	public class ItemStack implements Serializable,Cloneable{
		...
		/** to print final price use getFinalPrice method instead it's only for modifiers. */
	...
	/**
	 * If totalPrice is 0 then calculate, otherwise return previous calculated value ( usefull for example for order history )
	 * Use carefully!.
	 *
	...
	public String toString() {
		return Tools.printVars(this.getClass().getSimpleName(),true,true,new MyVar(this.date.toString(), "Date") 
		, new MyVar(this.getTotalPrice(), "Price"));
	}
}
